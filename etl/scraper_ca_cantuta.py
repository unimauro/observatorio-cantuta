#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Consulta Amigable MEF -> serie histórica pliego 528 (U.N. DE EDUCACION ENRIQUE GUZMAN Y VALLE - La Cantuta).
Drill: Año -> Nivel de Gobierno -> E: GOBIERNO NACIONAL -> Sector 10 EDUCACION -> Pliego 528.
Parsea PIA/PIM/Certificado/Comprometido/Devengado/Girado de la fila 528.
Guarda raw en ca_cantuta_raw.json. El merge lo hace merge_presupuesto.py.
...
def main():
    ...
    json.dump({str(y): r for y, r in results.items()},
              open(os.path.join(HERE, "ca_cantuta_raw.json"), "w"), ensure_ascii=False)
